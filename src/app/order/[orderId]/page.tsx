...
export default function OrderDetailPage() {
  ...
  return (
    <div className='min-h-screen bg-[#FBF8F4] flex flex-col items-center px-4'>
      ...
      <p className='text-[24px] font-bold text-[#1F1F1F] mb-4 mt-[70px] mr-[450px]'>
        상품정보
      </p>
      <div className='w-full max-w-xl bg-[#FBF8F4] border-y-2 border-[#E6E6E6] rounded-[16px] px-6 py-6 mb-6'>
        {firstItem && (
          <div className='flex flex-col gap-4'>
            <div className='w-[500px] h-[120px] flex items-center gap-4'>
              ...
              <div className='w-[300px] ml-3'>
                <p className='font-medium text-[18px] leading-[26px] align-middle text-[#1F1F1F]'>
